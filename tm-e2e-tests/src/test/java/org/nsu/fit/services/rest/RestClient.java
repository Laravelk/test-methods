...
import org.nsu.fit.tests.api.Subscription;
...
//    private static final String REST_URI = "http://localhost:8080/tm-backend/rest";
    ...
    public CustomerPojo createAutoGeneratedCustomer(AccountTokenPojo accountToken) {
        ...
        contactPojo.id = UUID.randomUUID();
    ...
    public SubscriptionPojo createSubscription(AccountTokenPojo accountTokenPojo, PlanPojo planPojo, CustomerPojo customer) {
        ...
        subscriptionPojo.balance = customer.balance;
    ...
    public SubscriptionPojo createBadSubscription(AccountTokenPojo accountTokenPojo, PlanPojo planPojo, CustomerPojo customer) {
        SubscriptionPojo subscriptionPojo = new SubscriptionPojo();
        subscriptionPojo.id = UUID.randomUUID();
        subscriptionPojo.customerId = customer.id;
        subscriptionPojo.planId = planPojo.id;
        subscriptionPojo.balance = 0;
        subscriptionPojo.planName = planPojo.name;
        subscriptionPojo.planDetails = planPojo.details;
        subscriptionPojo.planFee = planPojo.fee;
        return post("subscriptions", JsonMapper.toJson(subscriptionPojo, true), SubscriptionPojo.class, accountTokenPojo);
